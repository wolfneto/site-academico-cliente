        ...
        getSelectedOption() {
            ...
            if (this.modelValue != null && this.options) {
                for (let option of this.options) {
                    if ((utils.ObjectUtils.equals(this.modelValue, this.getOptionValue(option), this.equalityKey))) {
        ...
        getSelectedOptionIndex() {
            ...
            if (this.modelValue != null && this.visibleOptions) {
                for (let i = 0; i < this.visibleOptions.length; i++) {
                    if ((utils.ObjectUtils.equals(this.modelValue, this.getOptionValue(this.visibleOptions[i]), this.equalityKey))) {
              ...
              vue.createVNode("div", {
                ...
                vue.createVNode("ul", _hoisted_6, [
                  (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList($options.visibleOptions, (option, i) => {
                    ...
                    ], 10, ["aria-label", "onClick", "aria-selected"])), [
                      [_directive_ripple]
                    ])
                  }), 128)),
                  ($data.filterValue && (!$options.visibleOptions || ($options.visibleOptions && $options.visibleOptions.length === 0)))
                    ? (vue.openBlock(), vue.createBlock("li", _hoisted_7, vue.toDisplayString($props.emptyFilterMessage), 1))
                    : vue.createCommentVNode("", true)
                ])
              ], 4)
            ], 512))
