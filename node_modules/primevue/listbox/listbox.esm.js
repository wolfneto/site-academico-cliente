...
import { resolveDirective, openBlock, createBlock, createVNode, withDirectives, vModelText, createCommentVNode, Fragment, renderList, renderSlot, createTextVNode, toDisplayString } from 'vue';
  ...
  return (openBlock(), createBlock("div", _hoisted_1, [
    ...
    createVNode("div", {
      ...
      createVNode("ul", _hoisted_5, [
        (openBlock(true), createBlock(Fragment, null, renderList($options.visibleOptions, (option, i) => {
        ...
        ($data.filterValue && (!$options.visibleOptions || ($options.visibleOptions && $options.visibleOptions.length === 0)))
          ? (openBlock(), createBlock("li", _hoisted_6, toDisplayString($props.emptyFilterMessage), 1))
          : createCommentVNode("", true)
      ])
    ], 4)
  ]))
