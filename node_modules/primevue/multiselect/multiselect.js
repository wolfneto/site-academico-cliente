...
this.primevue.multiselect = (function (utils, Ripple, vue) {
    'use strict';
    ...
    var script = {
        ...
        methods: {
            ...
            findNextItem(item) {
                ...
                if (nextItem)
                    return utils.DomHandler.hasClass(nextItem, 'p-disabled') ? this.findNextItem(nextItem) : nextItem;
                else
                    return null;
            },
            findPrevItem(item) {
                  ...
                  vue.createVNode("div", {
                    ...
                    vue.createVNode("ul", _hoisted_10, [
                      (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList($options.visibleOptions, (option, i) => {
                        ...
                        ], 42, ["aria-selected", "aria-label", "onClick", "onKeydown", "tabindex"])), [
                          [_directive_ripple]
                        ])
                      }), 128)),
                      ($data.filterValue && (!$options.visibleOptions || ($options.visibleOptions && $options.visibleOptions.length === 0)))
                        ? (vue.openBlock(), vue.createBlock("li", _hoisted_12, vue.toDisplayString($props.emptyFilterMessage), 1))
                        : vue.createCommentVNode("", true)
                    ])
                  ], 4)
                ], 512))
