import { ObjectUtils, DomHandler, FilterUtils } from 'primevue/utils';
            ...
            (openBlock(true), createBlock(Fragment, null, renderList($options.columns, (col, i) => {
              return (openBlock(), createBlock("th", {
                ...
                ($props.resizableColumns)
                  ...
                  : createCommentVNode("", true),
                (openBlock(), createBlock(resolveDynamicComponent(col.children?.header), { column: col }, null, 8, ["column"])),
              ...
              createVNode("tr", null, [
                (openBlock(true), createBlock(Fragment, null, renderList($options.columns, (col, i) => {
                  return (openBlock(), createBlock("td", {
                    ...
                    (openBlock(), createBlock(resolveDynamicComponent(col.children?.footer), { column: col }, null, 8, ["column"])),
