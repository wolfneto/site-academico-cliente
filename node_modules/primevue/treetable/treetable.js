...
this.primevue.treetable = (function (utils, Ripple, vue, Paginator) {
    'use strict';
                ...
                for (let node of value) {
                    ...
                    for (let j = 0; j < this.columns.length; j++) {
                        ...
                        if (Object.prototype.hasOwnProperty.call(this.filters, this.columnProp(col, 'field'))) {
                            ...
                            let filterConstraint = utils.FilterUtils[filterMatchMode];
                        ...
                        if (this.hasGlobalFilter() && !globalMatch) {
                            ...
                            let filterConstraint = utils.FilterUtils['contains'];
                ...
                (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList($options.columns, (col, i) => {
                  return (vue.openBlock(), vue.createBlock("th", {
                    ...
                    ($props.resizableColumns)
                      ...
                      : vue.createCommentVNode("", true),
                    (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(col.children?.header), { column: col }, null, 8, ["column"])),
                  ...
                  vue.createVNode("tr", null, [
                    (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList($options.columns, (col, i) => {
                      return (vue.openBlock(), vue.createBlock("td", {
                        ...
                        (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(col.children?.footer), { column: col }, null, 8, ["column"])),
...
}(primevue.utils, primevue.ripple, Vue, primevue.paginator));
