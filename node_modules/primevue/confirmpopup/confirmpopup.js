...
this.primevue.confirmpopup = (function (ConfirmationEventBus, utils, Button, vue) {
    'use strict';
    ...
    var script = {
        ...
        container: null,
        mounted() {
            ConfirmationEventBus__default['default'].on('confirm', (options) => {
                if (!options) {
                    return;
                }
            ...
            ConfirmationEventBus__default['default'].on('close', () => {
                this.visible = false;
...
}(primevue.confirmationeventbus, primevue.utils, primevue.button, Vue));
